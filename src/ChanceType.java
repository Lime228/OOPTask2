...
public enum ChanceType {
    // TODO: 29.11.2023 Здесь неправильно описаны переходы, сафонов, переделать.
    // ПЕРЕХОД НА
...
//    DEWDROP(18, false, "У вас новая идея для газировки. Отправляйтесь на завод 'Росинка'. Если проходите старт, получаете 200."),
...
//    VK(11, false, "Вы давно не навещали своих друзей из VK, пора это исправить. Отправляйтесь в их офис."),
    ...
    DEBT_RECOVERY(100, true, "Ваш друг Александр наконец вернул вам долг."),
